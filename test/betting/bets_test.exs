defmodule Betting.BetsTest do
  ...
  describe "bets" do
    ...
    @invalid_attrs %{cancelled: nil, bet_amount: nil, settled_amount: nil}
    ...
    test "create_bet/1 with valid data creates a bet" do
      valid_attrs = %{cancelled: true, bet_amount: "120.5", settled_amount: "120.5"}

      assert {:ok, %Bet{} = bet} = Bets.create_bet(valid_attrs)
      assert bet.cancelled == true
